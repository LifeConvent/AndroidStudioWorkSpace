...
public class UpdateTool {
    ...
    private boolean isUpdate() {
        ...
        XmlTool service = new XmlTool();
        try {
            String path = BasicConfig.UPDATE_URL;//this.mContext.getText(R.string.Server_Url)+"m=AndroidUpdate&a=get";
...
<update>
    ...
    public static int getVersionCode(Context context) {
        ...
        try {
            ...
            versionCode = context.getPackageManager().getPackageInfo("com.nnit.diabetescare.diabetescare", 0).versionCode;
...
//        View v = inflater.inflate(R.layout.update_msk_progress, null);
//        mProgress = (ProgressBar) v.findViewById(R.id.update_pb_progress);
//        builder.setView(v);
//        // 取消更新
