...
import com.ex.idcardcheck.utils.FileUtil;
import com.ex.idcardcheck.utils.HttpUtil;
import com.ex.idcardcheck.utils.NetUtil;
...
public class ACameraActivity extends Activity implements Callback {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    Toast.makeText(getBaseContext(), "ÅÄÕÕÊ§°Ü", Toast.LENGTH_SHORT).show();
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (isavilable) {
                                    ...
                                    mHandler.sendMessage(mHandler.obtainMessage(3, "ÎÞÍøÂç£¬ÇëÈ·¶¨ÍøÂçÊÇ·ñÁ¬½Ó!"));
                                }
                            }
                        }).start();
                    }
                ...
                case 5:
                    ...
                    break;
                case 6:
                    Toast.makeText(getBaseContext(), "Çë²åÈë´æ´¢¿¨£¡", Toast.LENGTH_SHORT).show();
                    mCameraManager.initPreView();
                    break;
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            Toast.makeText(getBaseContext(), "Çë²åÈë´æ´¢¿¨", Toast.LENGTH_LONG).show();
            finish();
        }
